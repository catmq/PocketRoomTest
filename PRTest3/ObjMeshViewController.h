...
@protocol ObjMeshViewDelegate <NSObject>
...
@interface ObjMeshViewController : UIViewController <UIGestureRecognizerDelegate, MFMailComposeViewControllerDelegate>

@property (nonatomic, assign) id<ObjMeshViewDelegate> delegate;
