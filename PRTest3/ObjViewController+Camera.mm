...
@implementation ObjViewController (Camera)
                                 ...
                                 completionHandler:^(BOOL granted)
         {
             ...
             if (granted)
             {
                 dispatch_async(dispatch_get_main_queue(), ^(void) {
                     ...
                     _objappStatus.colorCameraIsAuthorized = true;
...
- (void)setupColorCamera
{
    ...
    {
        _objappStatus.colorCameraIsAuthorized = false;
        [self updateAppStatusMessage];
        return;
    }
    ...
    if([self.videoDevice lockForConfiguration:&error])
    {
        ...
        [self setLensPositionWithValue:_objoptions.lensPosition lockVideoDevice:false];
