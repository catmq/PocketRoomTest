...
- (instancetype)initWithContentsOfFile:(NSString *)nameOrPath
{
    ...
    if (dataPath && [[dataPath pathExtension] isEqualToString:@"atlasc"])
    {
        ...
        {
            //load atlas
            NSString *plistPath = [dataPath stringByAppendingPathComponent:
                                   [[[dataPath lastPathComponent] stringByDeletingPathExtension] stringByAppendingPathExtension:@"plist"]];
