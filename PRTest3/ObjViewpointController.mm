...
#include "ObjViewpointController.h"
...
struct ObjViewpointController::PrivateData
{
...
ObjViewpointController::ObjViewpointController (float screenSizeX, float screenSizeY)
: d (new PrivateData)
{
...
ObjViewpointController::~ObjViewpointController()
{
    delete d; d = 0;
}

void ObjViewpointController::reset()
{
...
void ObjViewpointController::setCameraProjection(GLKMatrix4 projRt)
{
    d->referenceProjectionMatrix = projRt;
    d->cameraOrProjectionChangedSinceLastUpdate = true;
}

void ObjViewpointController::setMeshCenter(GLKVector3 center)
{
    d->meshCenter = center;
    d->cameraOrProjectionChangedSinceLastUpdate = true;
}
...
void ObjViewpointController::onPinchGestureBegan(float scale)
{
    d->scaleWhenPinchGestureBegan = d->currentScale / scale;
}

void ObjViewpointController::onPinchGestureChanged(float scale)
{
...
void ObjViewpointController::onOneFingerPanBegan(GLKVector2 &touch)
{
    d->modelViewRotationWhenPanGestureBegan = d->modelViewRotation;
    d->oneFingerPanWhenGestureBegan = touch;
}

void ObjViewpointController::onOneFingerPanChanged(GLKVector2 &touch)
{
...
void ObjViewpointController::onOneFingerPanEnded(GLKVector2 vel)
{
...
void ObjViewpointController::onTwoFingersPanBegan(GLKVector2 &touch)
{
    d->twoFingersPanWhenGestureBegan = touch;
    d->meshCenterOnScreenWhenPanGestureBegan = d->meshCenterOnScreen;
}

void ObjViewpointController::onTwoFingersPanChanged(GLKVector2 &touch)
{
...
void ObjViewpointController::onTwoFingersPanEnded(GLKVector2 vel)
{
}

void ObjViewpointController::onTouchBegan()
{
...
GLKMatrix4 ObjViewpointController::currentGLModelViewMatrix() const
{
...
GLKMatrix4 ObjViewpointController::currentGLProjectionMatrix() const
{
...
bool ObjViewpointController::update()
{
...
GLKMatrix4 ObjViewpointController::currentProjectionCenterTranslation() const
{
